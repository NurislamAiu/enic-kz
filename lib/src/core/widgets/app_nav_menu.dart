...
class _AppNavMenuState extends State<AppNavMenu> {
  ...
  final Map<String, List<String>> subMenus = const {
    ...
    'Болон процесі': [
      ...
      'Мониторинг деятельности вузов по реализации принципов Болонского процесса (2022 год)',
      'Мониторинг деятельности вузов по реализации принципов Болонского процесса (2023 год - I полугодие)',
      'Мониторинг деятельности вузов по реализации принципов Болонского процесса (2023 год - II полугодие)',
      'Мониторинг деятельности вузов по реализации принципов Болонского процесса (2024 год)',
    ],
    'Мерзімді басылымдар': [
      'Журнал "Высшая школа Казахстана"',
      'Дайджесты',
    ],
    'Анықтамалық ақпарат': [
